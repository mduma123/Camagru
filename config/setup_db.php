...
try 
{
	$db = new PDO("mysql:$servername", $username , $password);
	...
	$comments = "CREATE TABLE IF NOT EXISTS Comments (id INT(11) UNSIGNED AUTO_INCREMENT PRIMARY KEY, 
	...
	$likes = "CREATE TABLE IF NOT EXISTS Likes (id INT(11) UNSIGNED AUTO_INCREMENT PRIMARY KEY,  
